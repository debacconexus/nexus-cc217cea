...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "AIRS Cyber-Attacker Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Global Threat Intelligence & Exploit Interception Unit (CISA / FIRST)";
process.env.TABLE_NAME = process.env.TABLE_NAME || "global_threat_intelligence___exploit_interception_unit__cisa___first__records";
'use strict';
